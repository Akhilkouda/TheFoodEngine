...
const getCollection = require("./getDBObj");
...
cartApp.get('/getcartproducts/:id', expressAsyncHandler(async(request, response)=>{
    ...
    let cartCollectionObject = await getCollection("cartcollection")
    //read all products
...
cartApp.post('/create-product', (request, response)=>{
    ...
    //get productCollectionObject
    let productCollectionObject = await getCollection("productCollectionObject")
